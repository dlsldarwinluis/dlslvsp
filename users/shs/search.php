...
<body>
    ...
    <div id="userSettingsContainer">
        <div id="userSettingsContent">
            <a href="/videostreamingportal/users/shs/myaccount.php" class="user-link">
            ...
            <a href="/videostreamingportal/users/shs/logout.php" class="user-link">
    ...
    <table class="user-tabledata" id="music">
        ...
        <tbody>
            <?php
                $music = mysqli_query($con, "SELECT * FROM videos WHERE title LIKE '%".$search."%' AND deleted='0' AND disabled='0' AND disapproved='0' || category LIKE '%".$search."%' AND deleted='0' AND disabled='0' AND disapproved='0' ORDER BY id DESC");

...
<body>
    ...
    <div id="userSettingsContainer">
        <div id="userSettingsContent">
            <a href="/videostreamingportal/users/ps/myaccount.php" class="user-link">
            ...
            <a href="/videostreamingportal/users/ps/logout.php" class="user-link">
    ...
    <table class="user-tabledata" id="music">
        ...
        <tbody>
            <?php
                $music = mysqli_query($con, "SELECT * FROM videos WHERE category='Music' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='1+' ORDER BY id DESC");
    ...
    <table class="user-tabledata" id="film">
        ...
        <tbody>
            <?php
                $film = mysqli_query($con, "SELECT * FROM videos WHERE category='Film' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='13+' || category='Film' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='1+' ORDER BY id DESC");
    ...
    <table class="user-tabledata" id="documentary">
        ...
        <tbody>
            <?php
                $docu = mysqli_query($con, "SELECT * FROM videos WHERE category='Documentary' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='13+' || category='Documentary' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='1+' ORDER BY id DESC");
    ...
    <table class="user-tabledata" id="tutorial">
        ...
        <tbody>
            <?php
                $tutor = mysqli_query($con, "SELECT * FROM videos WHERE category='Tutorials' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='13+' || category='Tutorials' AND deleted='0' AND disabled='0' AND disapproved='0' AND agerestriction='1+' ORDER BY id DESC");

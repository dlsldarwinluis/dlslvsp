...
<body>
    ...
    <div id="searchbuttonContainer">
        <div id="searchbuttonContent">
            <form action="recyclebin-deletedadminaccounts-search.php" method="post" class="searchForm">
    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                ...
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM admins WHERE fullname LIKE '%".$search."%' AND deleted='1' || email LIKE '%".$search."%' AND deleted='1' || office LIKE '%".$search."%' AND deleted='1' || classification LIKE '%".$search."%' AND deleted='1' ORDER BY id ASC");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="post">
                                            <button class="vid-button" id="delete" name="delete"><input type="hidden" name="id" id="id" value="<?php echo $row["id"] ?>"><input type="hidden" name="name" id="name" value="<?php echo $row["fullname"] ?>"><img src="/videostreamingportal/icons/restore.png" class="vid-buttonicon"></button>
                                        </form>
                                    </td>
                                </tr>
                                <?php
    ...
    <?php
        if(isset($_POST["delete"])){
            ...
            ?>
                <script>
                    alert("Admin account successfully restored!");

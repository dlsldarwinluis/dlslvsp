<?php
    ...
    if(!isset($_SESSION["session_adminname"]) && !isset($_SESSION["session_adminid"]) && !isset($_SESSION["session_adminoffice"])){
        ...
        $admid = $_SESSION["session_adminid"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <?php
        $query = mysqli_query($con, "SELECT * FROM admins WHERE id='$admid'");
            ...
            <form action="" method="post" id="addvideoForm">
                ...
                <div class="videoform-div">
                    <select name="adminprivelage" id="adminprivelage" class="videoform-select" required>
                        <option value="<?php echo $row["privelage"] ?>"><?php echo $row["privelage"] ?></option>
                        <option value="SUPER ADMIN">Super Admin</option>
                        <option value="STANDARD">Standard</option>
                    </select>
                </div>
                <div class="videoform-div">
                    <input type="text" id="adminpassword" name="adminpassword" class="videoform-input" value="<?php echo $row["passcode"] ?>" placeholder="Default Password" required>
                </div>
                <div class="videoform-div">
    ...
    <?php
        if(isset($_POST['vidsubmit'])){
            ...
            SET fullname = '$adminfullname', email = '$adminemail', passcode = '$adminpasscode', privelage = '$adminprivelage', classification = '$adminclassification', office = '$adminoffice'
            WHERE id = '$admid'");
            ?>
            <script>
                alert("Successfully Updated!");
                location.reload();
                window.location = "/videostreamingportal/admin/super/";
            </script>
            <?php

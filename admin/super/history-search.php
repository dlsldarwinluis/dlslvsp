...
<head>
    ...
    <link rel="stylesheet" href="/videostreamingportal/scripts/css/history.css">
</head>
<body>
    ...
    <div id="searchbuttonContainer">
        <div id="searchbuttonContent">
            <form action="history-search.php" method="post" class="searchForm">
    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM history WHERE actor LIKE '%".$search."%' || action LIKE '%".$search."%' || dateofaction LIKE '%".$search."%' ORDER BY id DESC");
                        ...
                        if($check != 0){
                            while($row = mysqli_fetch_assoc($query)){
                                ?>
                                <tr>
                                    <td><?php echo $row["actor"] . " " . $row["action"] . " last " . $row["dateofaction"] ?></td>
                                </tr>
                                <?php
                            }
                        }

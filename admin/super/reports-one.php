...
$output = '';
$sql = "SELECT * FROM videos WHERE source='CONTRIBUTOR' AND deleted='0' AND disapproved='0' AND disabled='0' ORDER BY id DESC";
$result = mysqli_query($connect, $sql);
	...
	if(mysqli_num_rows($result) > 0)
	{
		...
		header("Content-Disposition:attachment; filename=Inventory-ContributedVideos.xls");
		echo $output;
	}
	else{
		?>

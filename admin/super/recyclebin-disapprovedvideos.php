...
<body>
    ...
    <div id="searchbuttonContainer">
        <div id="searchbuttonContent">
            <form action="recyclebin-disapprovedvideos-search.php" method="post" class="searchForm">
    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                ...
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM videos WHERE deleted='1' AND disapproved='1' ORDER BY id ASC");

...
<body>
    ...
    <div id="searchbuttonContainer">
        <div id="searchbuttonContent">
            <form action="recyclebin-deletedvideos-search.php" method="post" class="searchForm">
    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                ...
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM videos WHERE title LIKE '%".$search."%' AND deleted='1' AND disapproved='1' || filename LIKE '%".$search."%' AND deleted='1' AND disapproved='1' || filetype LIKE '%".$search."%' AND deleted='1' AND disapproved='1' || source LIKE '%".$search."%' AND deleted='1' AND disapproved='1' || uploadedby LIKE '%".$search."%' AND deleted='1' AND disapproved='1' ORDER BY id ASC");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="post">
                                            <button class="vid-button" id="videorestore" name="videorestore"><input type="hidden" name="vidid" id="vidid" value="<?php echo $row["id"] ?>"><input type="hidden" name="vidtitle" id="vidtitle" value="<?php echo $row["title"] ?>"><img src="/videostreamingportal/icons/restore.png" class="vid-buttonicon"></button>
                                        </form>
                                    </td>
                                </tr>
                                <?php
    ...
    <?php
        if(isset($_POST["videorestore"])){
            $title = $_POST["vidtitle"];
            $id = $_POST["vidid"];

            mysqli_query($con, "UPDATE videos
            SET deleted = '0', disapproved = '0'
            WHERE id = '$id'");
            ?>
                <script>
                    alert("The video is now restored!");

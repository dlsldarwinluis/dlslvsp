...
<body>
    ...
    <div id="searchbuttonContainer">
        <div id="searchbuttonContent">
            <form action="admins-search.php" method="post" class="searchForm">
    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                ...
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM admins WHERE fullname LIKE '%".$search."%' AND deleted='0' || email LIKE '%".$search."%' AND deleted='0' || office LIKE '%".$search."%' AND deleted='0' || classification LIKE '%".$search."%' AND deleted='0' ORDER BY id ASC");
    ...
    <?php
        if(isset($_POST["delete"])){
            ...
            ?>
                <script>
                    alert("Admin moved to recycle bin!");

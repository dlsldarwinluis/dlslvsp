    ...
    <div id="tableContainer">
        <div id="tableContent">
            <table class="table-videos">
                ...
                <tbody>
                    <?php
                        $query = mysqli_query($con, "SELECT * FROM videos WHERE title LIKE '%".$search."%' AND deleted='1' AND disapproved='0' || filename LIKE '%".$search."%' AND deleted='1' AND disapproved='0' || filetype LIKE '%".$search."%' AND deleted='1' AND disapproved='0' || source LIKE '%".$search."%' AND deleted='1' AND disapproved='0' || uploadedby LIKE '%".$search."%' AND deleted='1' AND disapproved='0' ORDER BY id ASC");
